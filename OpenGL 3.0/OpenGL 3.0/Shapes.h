...
void DrawCubeFace(float fSize)
{
    fSize /= 2.0;
   // glBegin(GL_QUADS);
    glVertexAttrib3f(1,-fSize, -fSize, fSize);    //glTexCoord2f (0, 0);
    glVertexAttrib3f(1,fSize, -fSize, fSize);    // glTexCoord2f (1, 0);
    glVertexAttrib3f(1,fSize, fSize, fSize);     // glTexCoord2f (1, 1);
    glVertexAttrib3f(1,-fSize, fSize, fSize);   //  glTexCoord2f (0, 1);
    //glEnd();
}
